...
#Response of programme will depend on whether it's a weekday or weekend
 ...
 #need to import date/time module before can do any date manipulation
import datetime
...
#This is checking if the current day is in index 0-4 of the list. If this is the case, that means it's a weekday so will return that today is not the weekend
if currentDay in weekdays[:-2]:
    print("Hello, today is {}. Not the weekend sadly".format(currentDay))
  
#This part will run if the current day is one of the last two elements of the list, i.e. Saturday or Sunday
